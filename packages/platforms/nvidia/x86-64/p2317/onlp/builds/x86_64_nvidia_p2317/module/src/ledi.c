...
static onlp_led_info_t linfo[] =
{
    ...
    {
        { ONLP_LED_ID_CREATE(LED_FAN7), "Chassis LED 8 (FAN7 (13-14) )", 0 },
        ONLP_LED_STATUS_PRESENT,
        ONLP_LED_CAPS_ON_OFF | ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_GREEN_BLINKING |
        ONLP_LED_CAPS_ORANGE | ONLP_LED_CAPS_ORANGE_BLINKING | ONLP_LED_CAPS_AUTO,
    },
    {
        { ONLP_LED_ID_CREATE(LED_PSU_T3), "Chassis LED 9 (PSU LED)", 0 },
        ONLP_LED_STATUS_PRESENT,
        ONLP_LED_CAPS_ON_OFF | ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_GREEN_BLINKING |
        ONLP_LED_CAPS_ORANGE | ONLP_LED_CAPS_ORANGE_BLINKING | ONLP_LED_CAPS_AUTO,
    },
...
onlp_ledi_init(void)
{
    ...
    nvidia_platform_info_t* nvidia_platform_info = get_platform_info();
   	nvidia_platform_info->linfo = linfo;
   	nvidia_platform_info->led_fnames = file_names;
