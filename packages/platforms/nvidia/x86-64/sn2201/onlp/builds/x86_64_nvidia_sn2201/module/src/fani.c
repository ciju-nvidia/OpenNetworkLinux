...
#define SN2201_FAN_DEF_CAP   ONLP_FAN_CAPS_F2B
...
static plat_fan_t plat_fans[] = {
    [PLAT_FAN_ID_1] = {
        ...
        .present_data = NULL,
        .status_path = "/var/run/hw_managemant/thermal/fan1_status",
        .rpm_get_path = "/var/run/hw_managemant/thermal/fan1_speed_get",
        .rpm_set_path = "/var/run/hw_managemant/thermal/fan1_speed_set",
        .max_rpm = 22000,
        .per_get_path = "/var/run/hw_managemant/thermal/pwm1",
        .per_set_path = "/var/run/hw_managemant/thermal/pwm1",
        .caps = SN2201_FAN_DEF_CAP,
    ...
    [PLAT_FAN_ID_2] = {
        ...
        .present = _fan_present,
        .present_data = NULL,
        .status_path = "/var/run/hw_managemant/thermal/fan2_status",
        .rpm_get_path = "/var/run/hw_managemant/thermal/fan2_speed_get",
        .rpm_set_path = "/var/run/hw_managemant/thermal/fan2_speed_set",
        .max_rpm = 22000,
        .per_get_path = "/var/run/hw_managemant/thermal/pwm1",
        .per_set_path = "/var/run/hw_managemant/thermal/pwm1",
        .caps = SN2201_FAN_DEF_CAP,
    ...
    [PLAT_FAN_ID_3] = {
        ...
        .present = _fan_present,
        .present_data = NULL,
        .status_path = "/var/run/hw_managemant/thermal/fan3_status",
        .rpm_get_path = "/var/run/hw_managemant/thermal/fan3_speed_get",
        .rpm_set_path = "/var/run/hw_managemant/thermal/fan3_speed_set",
        .max_rpm = 22000,
        .per_get_path = "/var/run/hw_managemant/thermal/pwm1",
        .per_set_path = "/var/run/hw_managemant/thermal/pwm1",
        .caps = SN2201_FAN_DEF_CAP,
    ...
    [PLAT_FAN_ID_4] = {
        ...
        .present = _fan_present,
        .present_data = NULL,
        .status_path = "/var/run/hw_managemant/thermal/fan4_status",
        .rpm_get_path = "/var/run/hw_managemant/thermal/fan4_speed_get",
        .rpm_set_path = "/var/run/hw_managemant/thermal/fan4_speed_set",
        .max_rpm = 22000,
        .per_get_path = "/var/run/hw_managemant/thermal/pwm1",
        .per_set_path = "/var/run/hw_managemant/thermal/pwm1",
        .caps = SN2201_FAN_DEF_CAP,
...
static int _fan_present(void *e)
{
    ...
    if (fan->status_path) {
        plat_os_file_read_int(&fan_status, fan->status_path, NULL);

        if (fan_status == 0) fan->state = PLAT_FAN_STATE_UNPRESENT;
...
int onlp_fani_info_get(onlp_oid_t id, onlp_fan_info_t* info)
{
    ...
    if (present) {
        ...
        if (info->percentage > 0 && error == 0) {
            /* 20% tolerance */
            rpm_thrs_down = (info->percentage * fan->max_rpm * 80) / 10000;
            rpm_thrs_up = (info->percentage * fan->max_rpm * 120) / 10000;
            if (info->rpm < rpm_thrs_down || info->rpm > rpm_thrs_up) {
