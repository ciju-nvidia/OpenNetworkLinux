...
static plat_psu_t plat_sn2201_psus[] = {
    [PLAT_PSU_ID_1] = {
        .name = "PSU1",
        .present = _psu_present,
        .present_path = "/var/run/hw_managemant/thermal/psu1_status",
        .power_status_path = "/var/run/hw_managemant/thermal/psu1_pwr_status",
        .vin_path = "/var/run/hw_managemant/power/psu1_volt_in",
        .iin_path = "/var/run/hw_managemant/power/psu1_curr_in",
        .pin_path = "/var/run/hw_managemant/power/psu1_power_in",
    ...
    [PLAT_PSU_ID_2] = {
        .name = "PSU2",
        .present = _psu_present,
        .present_path = "/var/run/hw_managemant/thermal/psu2_status",
        .power_status_path = "/var/run/hw_managemant/thermal/psu2_pwr_status",
        .vin_path = "/var/run/hw_managemant/power/psu2_volt_in",
        .iin_path = "/var/run/hw_managemant/power/psu2_curr_in",
        .pin_path = "/var/run/hw_managemant/power/psu2_power_in",
        .event_callback = _psu_event,
...
{
    if (gPlat_id == PID_SN2201)
        return plat_sn2201_psus;
    else
        return NULL;
}
