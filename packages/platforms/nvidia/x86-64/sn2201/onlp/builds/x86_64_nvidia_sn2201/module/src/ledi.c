...
static plat_led_t plat_leds[] = {
    [PLAT_LED_ID_1] = {
        .name = "Front LED - PSU",
        .led_get_path = "/var/run/hw_managemant/led/led_psu",
        .led_set_path = "/var/run/hw_managemant/led/led_psu",
        .mode = {
            PLAT_LED_MODE(ONLP_LED_MODE_OFF,    LED_MODE_OFF),
            PLAT_LED_MODE(ONLP_LED_MODE_GREEN,  LED_MODE_GREEN),
            PLAT_LED_MODE(ONLP_LED_MODE_GREEN_BLINKING,  LED_MODE_GREEN_BLINK),
            PLAT_LED_MODE(ONLP_LED_MODE_YELLOW, LED_MODE_YELLOW),
            PLAT_LED_MODE(ONLP_LED_MODE_YELLOW_BLINKING,  LED_MODE_YELLOW_BLINK),
            PLAT_LED_MODE_END,
        },
    ...
    [PLAT_LED_ID_2] = {
        .name = "Front LED - FAN",
        .led_get_path = "/var/run/hw_managemant/led/led_fan",
        .led_set_path = "/var/run/hw_managemant/led/led_fan",
        .mode = {
            PLAT_LED_MODE(ONLP_LED_MODE_OFF,    LED_MODE_OFF),
            PLAT_LED_MODE(ONLP_LED_MODE_GREEN,  LED_MODE_GREEN),
            PLAT_LED_MODE(ONLP_LED_MODE_GREEN_BLINKING,  LED_MODE_GREEN_BLINK),
    ...
    [PLAT_LED_ID_3] = {
        .name = "Front LED - SYS",
        .led_get_path = "/var/run/hw_managemant/led/led_status",
        .led_set_path = "/var/run/hw_managemant/led/led_status",
        .mode = {
            PLAT_LED_MODE(ONLP_LED_MODE_OFF,    LED_MODE_OFF),
            PLAT_LED_MODE(ONLP_LED_MODE_GREEN,  LED_MODE_GREEN),
            PLAT_LED_MODE(ONLP_LED_MODE_GREEN_BLINKING,  LED_MODE_GREEN_BLINK),
        ...
        [PLAT_LED_ID_4] = {
        .name = "Front LED - UID",
        .led_get_path = "/var/run/hw_managemant/led/led_uid",
        .led_set_path = "/var/run/hw_managemant/led/led_uid",
        .mode = {
            PLAT_LED_MODE(ONLP_LED_MODE_OFF,    LED_MODE_OFF),
            PLAT_LED_MODE(ONLP_LED_MODE_BLUE,   LED_MODE_BLUE),
            PLAT_LED_MODE(ONLP_LED_MODE_BLUE_BLINKING,  LED_MODE_BLUE_BLINK),
            PLAT_LED_MODE_END,
        },
        PLAT_LED_INTERNAL_DEF,
    },
