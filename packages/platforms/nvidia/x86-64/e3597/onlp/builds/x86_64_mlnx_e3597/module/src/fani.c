...
#define FAN_13_ON_MAIN_BOARD 13
#define FAN_14_ON_MAIN_BOARD 14
#define FAN_1_ON_PSU1       15
#define FAN_1_ON_PSU2       16

#define FIRST_PSU_FAN_ID 15
...
static fan_path_T fan_path[] =  /* must map with onlp_fan_id */
{
	...
	MAKE_FAN_PATH_ON_MAIN_BOARD(PROJECT_NAME, FAN_13_ON_MAIN_BOARD),
	MAKE_FAN_PATH_ON_MAIN_BOARD(PROJECT_NAME, FAN_14_ON_MAIN_BOARD),
...
onlp_fan_info_t finfo[] = {
	...
	MAKE_FAN_INFO_NODE_ON_MAIN_BOARD(13),
	MAKE_FAN_INFO_NODE_ON_MAIN_BOARD(14),
...
onlp_fani_init(void)
{
    ...
    nvidia_platform_info->finfo = finfo;
    nvidia_platform_info->fan_fnames = fan_path;
    nvidia_platform_info->min_fan_speed = min_fan_speed;
    nvidia_platform_info->max_fan_speed = max_fan_speed;
    nvidia_platform_info->fan_type = FAN_TYPE_NO_EEPROM;
    nvidia_platform_info->fan_per_module = 2;
    nvidia_platform_info->first_psu_fan_id = FIRST_PSU_FAN_ID;
