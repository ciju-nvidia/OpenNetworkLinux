 ...
 *
 * @file
 * @brief nvidia_common Main Interface Header
 *
 * @addtogroup nvidia_common
 * @{
 *
 *****************************************************************************/
#ifndef __NVIDIA_COMMON_H__
#define __NVIDIA_COMMON_H__
...
typedef struct nvidia_platform_info_s {
