...
#include "x86_64_sugon_sgn2410_int.h"
...
int mc_get_platform_info(mlnx_platform_info_t* mlnx_platform)
{
	if (!__ONL_PLATFORM_NAME) {
		aim_strlcpy(mlnx_platform->onl_platform_name, "x86-64-sugon-sgn2410-all", PLATFORM_NAME_MAX_LEN);
	}
	else {
...
int onlp_sysi_platform_set(const char* platform)
{
	...
	if (!strcmp(platform, "x86-64-sugon-sgn2410-r0")) {
		__ONL_PLATFORM_NAME = "x86-64-sugon_sgn2410-r0";
